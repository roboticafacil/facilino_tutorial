...
Blockly.Events.Abstract = function(e) {
    ...
    Blockly.utils.createSvgElement("feGaussianBlur", { in : "SourceAlpha", stdDeviation: 1, result: "blur"
    }, i);
    var s = Blockly.utils.createSvgElement("feSpecularLighting", { in : "blur", surfaceScale: 1, specularConstant: .5, specularExponent: 10, "lighting-color": "white", result: "specOut"
    }, i);
    return Blockly.utils.createSvgElement("fePointLight", {
        x: -5e3,
        y: -1e4,
        z: 2e4
    }, s), Blockly.utils.createSvgElement("feComposite", { in : "specOut", in2: "SourceAlpha", operator: "in", result: "specOut"
    }, i), Blockly.utils.createSvgElement("feComposite", { in : "SourceGraphic", in2: "specOut", operator: "arithmetic", k1: 0, k2: 1, k3: 1, k4: 0
